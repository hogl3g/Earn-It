...
export function compareTeams(
  ...
  const scheduleA = getScheduleContext((metricA || { team_name: 'Unknown' }) as TeamMetrics);
  const scheduleB = getScheduleContext((metricB || { team_name: 'Unknown' }) as TeamMetrics);
